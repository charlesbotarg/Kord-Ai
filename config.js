...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'kord_ai-t9dggqMXVfwq2kzT',
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2349026609340",
    ...
    OWNER_NAME: process.env.OWNER_NAME || "Charles",
    BOT_NAME: process.env.BOT_NAME || "CHARLES BOT",
    RENDER_API_KEY: process.env.RENDER_API_KEY || "rnd_UxPSoBVwqRMg1GUsnwpFo25fpmPC",
